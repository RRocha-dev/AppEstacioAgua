import 'dart:async';
import 'dart:io';
import 'package:estacio/water_notifier.dart';
...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  late WaterNotifier waterNotifier;

  @override
  void initState() {
    super.initState();
    waterNotifier = WaterNotifier();
    waterNotifier.getValues();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          AnimatedBuilder(
              animation: waterNotifier,
              builder: (context, _) {
                return Stack(
                  children: [
                    Center(
                      child: Text(waterNotifier.value + '%',
                          style: TextStyle(
